    ...
    <div className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-left">
              ...
              >
                ...
                <a
                  href={`https://wa.me/${whatsappNumber}?text=Hi%20Saachi%20Tours%2526Travels,%20I%20want%20to%20plan%20a%20holiday.%20Please%20share%20details.`}
                  target="_blank"
      ...
      <section className="py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          ...
          <Link
            href="/gallery"
            className="flex items-center space-x-1.5 text-teal-400 hover:text-teal-350 font-semibold text-sm mt-4 md:mt-0 group"
          >
